...
if len(sys.argv) == 2:
	...
	# Get Data
	if sys.argv[1] == "MNIST":
		MNIST = input_data.read_data_sets("data.original_mnist/", one_hot=True)
	elif sys.argv[1] == "notMNIST":
		MNIST = input_data.read_data_sets("data/", one_hot=True)
	else:
		print("This should be used like this:\n--->python Q2_1_sol.py MNIST\n--->python Q2_1_sol.py notMNIST")
		sys.exit()
	# Parameters
	learning_rate = 0.01
	batch_size = 100
